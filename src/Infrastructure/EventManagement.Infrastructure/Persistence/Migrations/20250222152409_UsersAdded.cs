    ...
    public partial class UsersAdded : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EventUsers", x => new { x.RegisteredEventsId, x.RegisteredUsersId });
                    table.ForeignKey(
                        name: "FK_EventUsers_Events_RegisteredEventsId",
                        column: x => x.RegisteredEventsId,
                        principalTable: "Events",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EventUsers_Users_RegisteredUsersId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventUsers_RegisteredUsersId",
                table: "EventUsers",
